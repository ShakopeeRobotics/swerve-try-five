...
public class SwerveDrivetrain extends SubsystemBase {
    ...
    public Command goToAprilTag(int aprilTag) {
        Pose2d target = Constants.kAprilTags.getTagPose(aprilTag).get().toPose2d();
        return this.goToPosCommand(target
            .rotateAround(target.getTranslation(), Rotation2d.k180deg)
            .transformBy(new Transform2d(-Constants.kRobotDepth * Constants.kBitMoreThanHalf, 0.0, Rotation2d.kZero)))
