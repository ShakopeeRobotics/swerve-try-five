...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public static final double launchFuelIntakeLauncherMotorSpeed = 0.706; // 10.6*0.8/12
    ...
    public Command launchCommand() {
        return this.run(() -> {
           ...
           intakeLauncherRollerMotor.set(launchFuelIntakeLauncherMotorSpeed);
           feederRollerMotor.set(postLaunchFeederRollerMotorSpeed);
    ...
    public Command shortLaunchCommand() {
        return this.run(() -> {
            ...
            feederRollerMotor.set(launchFuelShortFeederRollerMotorSpeed);
        //}).withTimeout(1).andThen(() -> {
